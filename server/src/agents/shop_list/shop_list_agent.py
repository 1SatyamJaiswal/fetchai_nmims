...
async def message_handler(ctx: Context, sender: str, msg: ChatSupportMessage):
    ...
    print("list query received: ", msg.query)
    ...
    await ctx.send(sender, CustomerAssistantMessage(msg_type=MessageType.LIST,msg="I am a chat support agent, I am here to help list shopping"))